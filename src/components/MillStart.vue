...
<template>
  <div class="overflow-x-auto mt-10">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 text-gray-400">
      ...
      <tbody>
          <tr v-for = "run in millRotor" class="bg-slate-900 border-b bg-gray-800 border-gray-700 text-white text-center">
              ...
              <td class="px-7 py-4">
                <input class="bg-slate-900 bg-gray-700 light:[color-scheme:light]" type="datetime-local" id="selectedDateTime" v-model="selectedDateTime">
              </td>
              <td class="px-7 py-4">
                <button class="bg-red-700 bg-gray-700 py-2 rounded-md min-w-24" @click="start(run.millId, run.rotorId)">START</button>
              </td>
          </tr>
      </tbody>
    </table>
